...
server = driver.find_element_by_xpath('//a[@aria-label="'+ server_name +'"]')
server.click()
channel = driver.find_element_by_xpath('//div[@aria-label="'+ channel_name +' (text channel)"]')
channel.click()

if spam_time < 0:
    try:
        while True:
            textbox = driver.find_element_by_xpath('//*[@id="app-mount"]/div[2]/div/div[2]/div/div/div/div/div[2]/div/main/form/div/div/div/div/div[3]/div[2]/div')
